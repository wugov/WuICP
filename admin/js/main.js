...
function passRecord(recordId) {
    $.post('index.php', {action: 'pass', id: recordId}, function (response) {
        console.log(response);
...
function rejectRecord(recordId) {
    $.post('index.php', {action: 'reject', id: recordId}, function (response) {
        console.log(response);
        location.reload(); // Reload the page to reflect changes
    });
}
...
function deleteRecord(recordId) {
    $.post('index.php', {action: 'delete', id: recordId}, function (response) {
        console.log(response);
        location.reload(); // Reload the page to reflect changes
    });
}
